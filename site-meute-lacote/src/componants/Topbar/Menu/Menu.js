...
const menu = () => (
    <div className={classes.Buttons}>
        ...
        <div className={classes.Button}><Link to="/nextgc" style={{textDecoration: 'none'}}>Prochaine Sortie</Link></div>
        ...
        <div className={classes.Button}><Link to="/contacts" style={{textDecoration: 'none'}}>Contacts</Link></div>
    </div>
)
